...
namespace EInfrastructure.HelpCommon
{
    public class EMailCommon
    {
        ...
        public static ResultContent SendEmail(string pToMail, string pMailTitle, string pMailBoby, string pMailAddress, string pSmtpClient, string pPwd, string returnstr)
        {
            ...
            try
            {
                ...
                return ResultContent.Success(returnstr);
            }
            catch (SmtpException ex)
            {
                return ResultContent.Err(ex.Message);
            }
            catch (Exception ex)
            {
                return ResultContent.Err(ex.Message);

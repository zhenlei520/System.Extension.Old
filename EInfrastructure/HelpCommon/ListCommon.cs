...
namespace EInfrastructure.HelpCommon
{
    ...
    public static class ListCommon
    {
        ...
        /// <param name="c"></param>
        /// <returns></returns>
        public static string ToStringByListSimple<T>(this List<T> s, char c = ',') where T : IComparable
        {
            if (s == null || s.Count == 0)
            {
                return "";
        ...
        /// <param name="c"></param>
        /// <returns></returns>
        public static string ToStringByStringArraySimple(this string[] s, char c = ',')
        {
        ...
        #region List转String(复杂转换)

        /// <summary>
        /// List转String(复杂转换)
        /// </summary>
        /// <param name="s">带转换的list集合</param>
        /// <param name="isReplaceNull">是否移除Null或者空字符串</param>
        /// <param name="c"></param>
        /// <returns></returns>
        public static string ToStringByListHigh<T>(this List<T> s, bool isReplaceNull = true, char c = ',') where T : IComparable
        {
            if (s == null || s.Count == 0)
            {
                return "";
        ...
        /// <param name="c"></param>
        /// <returns></returns>
        public static string ToStringByStringArrayHigh(this string[] s, bool isReplaceNull = true, char c = ',')
        {
            if (s == null || s.Length == 0)
            {
                return "";
